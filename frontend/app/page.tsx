      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Share files with expiry, payments & cross-chain swaps on Polygon
          </p>
          <div className="flex justify-center space-x-4 flex-wrap gap-4">
            <Link href="/upload" className="px-8 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition text-lg font-semibold shadow-lg hover:shadow-xl">
              📤 Upload File
            </Link>
            <Link href="/dashboard" className="px-8 py-3 bg-white text-primary-600 border-2 border-primary-500 rounded-lg hover:bg-primary-50 transition text-lg font-semibold shadow-lg hover:shadow-xl">
              📊 View Dashboard
            </Link>
          </div>
        </div>
